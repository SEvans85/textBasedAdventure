...
def main():
    ...
    my_hero = build_hero(name=my_hero["name"], hero=my_hero["hero"], special=my_hero["special"])
    print(my_hero)
    print(my_hero.special_move())
    print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + "OK Okay! Well roll the dice then, lets see what grusome mystery awaits you!")
    print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + "Im waiting.. if you're ready to meet your doom just 'roll' the dice.")
    roll = ""
    while roll != "roll":
        roll = input(">>")
    print(roll_dice())
...
def roll_dice():
    ...
    return Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + f"You rolled a {roll}, oh boy you are in trouble! .. \n"
...
def jenkins_response(value):
    ...
    response = {
        5: ["A perfect 5! Well i doubt you will be so lucky next time!", "LOL GOOD ONE", "NICEEE"],
    ...
    # more options needed
    if value > 3:
        print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + "heHeheHe.. You're good!")
        print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + random.choice(response[value]))
    else:
        print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + "uhh ohh, you're in trouble!!")
        print(Fore.RED + "Jenkins Jester: " + Style.RESET_ALL + random.choice(response[value]))
...
def choose_your_destiny():
    ...
    while not name:
        ...
        if len(name) > 20:
            raise ValueError("The maximum characters for your hero's name is 20 characters.")
